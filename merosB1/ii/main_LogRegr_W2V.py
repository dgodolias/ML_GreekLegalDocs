...
# ...existing code...
    ...
    feature_config = {
        ...
        'params': {
            ...
            # 'seed' will be set to RANDOM_STATE in utils for K-Fold
        }
    }
    
    model_class = LogisticRegression
    model_init_params = {'solver': 'liblinear', 'max_iter': 1000} # random_state handled by utils
    ...
    if PERFORM_K_FOLD_CV:
        ...
        vector_size = w2v_single_run_params.get('vector_size', 100)
