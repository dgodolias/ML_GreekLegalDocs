...
from utils import (
    ...
    run_experiment, # Changed from perform_k_fold_cv_and_report and run_classification_and_report
    script_execution_timer
)

# --- Configuration ---
DATASET_CONFIG = "subject" # available options: "volume", "chapter", "subject"
SUBSET_PERCENTAGE = 1.0 # 1.0 for full data, < 1.0 for subset (e.g., 0.2 for 20%)
...
def main_svm_bow():
    ...
    # Base identifier for outputs, including dataset config
    ...
    success = run_experiment(
        ...
        base_run_identifier=base_run_id, # Pass the full base_run_id
